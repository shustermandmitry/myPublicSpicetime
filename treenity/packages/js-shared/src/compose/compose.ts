...
function composeRecursive<T = any>(middleware: AsyncMiddleware<T>[]) {
...
// export { composeRecursive as compose };
export { composeRecursive };
export { composeUnfolded as compose } from './compose-unfolded';
