...
import { TestEntityServer } from './test-no-type.entity.server';
...
describe('client entity', () => {
  beforeEach(async () => {
    ...
    testEntity = await manager.ensure(entityData, actions, TestEntityClient);
  });
  ...
  test('can be created without subscribe', async () => {
    ...
    const entity = manager.ensure({ ...entityData, $id: 'id2' }, actions, TestEntityClient);
