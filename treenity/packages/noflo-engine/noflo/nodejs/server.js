...
exports.liveUrl = (options, silent = false) => {
  ...
  if ((!options.tlsKey || !options.tlsCert) && liveUrl.protocol === 'https:') {
    if (!silent) {
      ...
      console.warn(
        'You can use insecure version of the IDE, or enable secure WebSockets with --tls-key and --tls-cert options',
      );
    }
